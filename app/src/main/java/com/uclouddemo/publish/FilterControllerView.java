...
//        ButterKnife.bind(this);
        skinBlur = (SeekBar)this.findViewById(R.id.seek_bar_skin_blur);
        skinBlurProgress = (TextView) this.findViewById(R.id.txtv_skin_blur_progress);
        skinRuddy = (SeekBar)this.findViewById(R.id.seek_bar_skin_ruddy);
        skinRuddyProgress = (TextView) this.findViewById(R.id.txtv_skin_ruddy_progress);
        skinWhitening = (SeekBar)this.findViewById(R.id.seek_bar_skin_whitening);
        skinWhiteningProgress = (TextView)this.findViewById(R.id.txtv_skin_whitening_progress);
