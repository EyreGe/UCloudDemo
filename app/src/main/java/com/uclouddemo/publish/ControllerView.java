...
//            ButterKnife.bind(this, view);
            switchCameraBtn = (Button)view.findViewById(R.id.btn_switch_camera);
            toggleFaceDetectorBtn = (Button)view.findViewById(R.id.btn_toggle_face_detector);
            toggleFlashmodeBtn = (Button)view.findViewById(R.id.btn_toggle_flashmode);
            bottombar = (FrameLayout)view.findViewById(R.id.fl_bottombar);
            toggleCodecModeBtn = (Button)view.findViewById(R.id.btn_toggle_codec_mode);
            toggleRenderModeBtn = (Button)view.findViewById(R.id.btn_toggle_render_mode);
            toggleCaputreOrientationBtn = (Button)view.findViewById(R.id.btn_toggle_caputre_orientation);
            exitBtn = (Button)view.findViewById(R.id.btn_exit);
            rightbarScrollView = (ScrollView)view.findViewById(R.id.scrollview_rightbar);
            bitrateTxtv = (TextView) view.findViewById(R.id.txtv_bitrate);
            recordingTimeTxtv = (TextView) view.findViewById(R.id.txtv_recording_time);
            framerateTxtv = (TextView) view.findViewById(R.id.txtv_framerate);
            streamEnvInfoTxtv = (TextView) view.findViewById(R.id.txtv_stream_env_info);
            networkBlockCountTxtv = (TextView) view.findViewById(R.id.txtv_network_block_count);
            debugLogTxtv = (TextView) view.findViewById(R.id.txtv_debug_log);
            debugLogPannelScrollView = (ScrollView) view.findViewById(R.id.scrollview_debug_log_pannel);
            debugInfoPannel = (FrameLayout) view.findViewById(R.id.fl_debug_info_pannel);
            copyToClipboardTxtv = (TextView) view.findViewById(R.id.txtv_copy_to_clipboard);
            toggleFilterBtn = (Button) view.findViewById(R.id.btn_toggle_filter);
            toggleRecordBtn = (Button) view.findViewById(R.id.btn_toggle_record);
            toggleMuteBtn = (Button) view.findViewById(R.id.btn_toggle_mute);
            toggleMixBtn = (Button) view.findViewById(R.id.btn_toggle_mix);
            toggleMirrorBtn = (Button) view.findViewById(R.id.btn_toggle_mirror);
            toggleDebugLogVivisbleTxtv = (TextView) view.findViewById(R.id.txtv_toggle_debug_log_vivisble);
            clearDebugLogTxtv = (TextView) view.findViewById(R.id.txtv_clear_debug_log);
            captureframeBtn = (Button) view.findViewById(R.id.btn_captureframe);
            hintCameraFrameImgView = (ImageView) view.findViewById(R.id.imgview_cameraframe);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_toggle_render_mode:
                ...
                break;
            case R.id.btn_toggle_caputre_orientation:
                if (mOuterOnControllerViewClickListener != null) {
