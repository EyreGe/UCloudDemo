...
import com.uclouddemo.publish.audio.UAudioMuteFilter;
import com.uclouddemo.publish.audio.URawAudioMixFilter;
import com.uclouddemo.publish.faceu.FaceuCompat;
...
//            ButterKnife.bind(this, view);
            mLiveCameraView = (LiveCameraView)view.findViewById(R.id.livecamera);
            mControllerView = (ControllerView)view.findViewById(R.id.livecamera_pannel);
            mStreamOverContainer = (RelativeLayout)view.findViewById(R.id.live_finish_container);
            backMainIndexButton = (Button)view.findViewById(R.id.btn_finish);
            mFilterControllerView = (FilterControllerView)view.findViewById(R.id.filter_level_bar);
    ...
    private OnClickListener backMainIndexButtonClickListener = new OnClickListener(){
    ...
    private void recoverSpecialEffect(SpecailEffectHolder specailEffectHolder) {
        ...
        if (specailEffectHolder.mix) {
            URawAudioMixFilter URawAudioMixFilter = new URawAudioMixFilter(getContext(), com.uclouddemo.publish.audio.URawAudioMixFilter.Mode.ANY, true);
