...
//		ButterKnife.bind(this);
		...
		mPlayPauseButton = (ImageButton)findViewById(R.id.img_bt_pause_play);
		mSeekBar = (SeekBar)findViewById(R.id.seekbar);
		mFastSeekBar = (SeekBar)findViewById(R.id.fast_seekbar);
		mCurrentPositionTxtv = (TextView)findViewById(R.id.txtv_current_position);
		mDurationTxtv = (TextView)findViewById(R.id.txtv_duration);
		mSeekingIndexTxtv = (TextView)findViewById(R.id.fast_seek_index_txtv);
		mSeekIndexView = (ViewGroup)findViewById(R.id.fast_seek_index_rl);
		mBrightnessImgBtn = (ImageButton)findViewById(R.id.img_btn_brightness);
		mVolumeImgBtn = (ImageButton)findViewById(R.id.img_btn_volume);
