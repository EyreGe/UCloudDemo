...
//        ButterKnife.bind(this);
        ...
        mLoadingView = (View)findViewById(R.id.txtv_loading);
        mNetworkBlockCount = (TextView)findViewById(R.id.txtv_block_count);
        Intent i = getIntent();
//        uri = i.getStringExtra(MainActivity.KEY_PLAY_ADDRESS);
        uri = "http://vlive3.rtmp.cdn.ucloud.com.cn/ucloud/1111.flv";
